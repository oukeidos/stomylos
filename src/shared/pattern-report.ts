...
export interface PatternSource {
  session_id: string; analysis_id: string; ended_at: string; source_hash: string;
  units: PatternUnit[];
}
...
export interface PatternCommandArgs {
  ...
  patternPreview: undefined; patternState: undefined; patternClose: undefined; patternRetrySave: undefined;
  patternCreate: { fingerprint: string; operationId: string };
