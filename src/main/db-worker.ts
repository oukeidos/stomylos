...
const methods: StoreMethod[] = ['coldInitialize','coldTick','coldClaim','coldComplete','coldFail','coldRelease','coldIndexFailure','coldPage','coldDelete','coldRetry','coldStatus', 'retryMemoryAdd','skipMemoryAdd','memoryAddReady','prepareMemoryAdd','dispatchMemoryAdd','receiveMemoryAdd','acceptMemoryAdd','failMemoryAdd','prepareProvider', 'resumeEndResponse', 'endStatus', 'endBlocker', 'endBlockers', 'assertEndActive', 'takeAutomaticRetry', 'suppressAutomaticRetry', 'receiveEndResponse', 'endResponse', 'clearEndResponse', 'cancelEnd', 'memoryCandidate', 'cleanupAttempts', 'prepareCleanup', 'dispatchCleanup', 'receiveCleanup', 'acceptCleanup', 'failCleanup', 'explainPrepare', 'explainList', 'explainGet', 'explainStart', 'explainFinish', 'patternRelated', 'patternPreview', 'patternCreate', 'patternAttempt', 'patternDispatch', 'patternRetry', 'patternSave', 'patternFinish', 'patternList', 'patternDetail', 'patternHtml', 'patternAffected', 'patternDelete', 'sessions', 'sessionPage', 'unfinished', 'session', 'messages', 'requests', 'request', 'units', 'view',
