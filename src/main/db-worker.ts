...
const methods: StoreMethod[] = ['jevBegin','jevPrepare','jevDispatch','jevFinish','wordCloudPreference', 'setWordCloudPreference', 'dadouchosRequestStart', 'dadouchosRequestFinish', 'openerView','prepareOpener','dispatchOpener','receiveOpener','acceptOpener','failOpener', 'requestHistory', 'genieRequestStart', 'genieRequestFinish', 'explainPrepare', 'explainList', 'explainGet', 'explainStart', 'explainFinish', 'coldInitialize','coldTick','coldClaim','coldComplete','coldFail','coldRelease','coldIndexFailure','coldPage','coldDelete','coldRetry','coldStatus','associativeTick','associativeClaim','associativeComplete','associativeRelease','associativeFail','associativePending','associativeSelection','associativeInput','associativeFromInput','associativeForMessage','associativeAssertNotRevoked', 'retryMemoryAdd','skipMemoryAdd','memoryAddReady','prepareMemoryAdd','dispatchMemoryAdd','receiveMemoryAdd','acceptMemoryAdd','failMemoryAdd','prepareProvider', 'resumeEndResponse', 'endStatus', 'endBlocker', 'endBlockers', 'assertEndActive', 'takeAutomaticRetry', 'suppressAutomaticRetry', 'receiveEndResponse', 'endResponse', 'clearEndResponse', 'cancelEnd', 'memoryCandidate', 'cleanupAttempts', 'prepareCleanup', 'dispatchCleanup', 'receiveCleanup', 'acceptCleanup', 'failCleanup', 'patternRelated', 'patternPreview', 'patternCreate', 'patternAttempt', 'patternDispatch', 'patternRetry', 'patternSave', 'patternFinish', 'patternList', 'patternDetail', 'patternHtml', 'patternAffected', 'patternDelete', 'sessions', 'sessionPage', 'unfinished', 'session', 'messages', 'requests', 'request', 'units', 'view',
