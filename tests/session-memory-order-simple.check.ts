...
const sentence='Sort the records from oldest to newest.';
it('probes the authorized session with the simplified chronology sentence exactly three times',async()=>{
 const directory='test-results/session-memory-order-simple';mkdirSync(directory,{recursive:true,mode:0o700});
