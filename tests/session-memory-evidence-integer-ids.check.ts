// Explicit three-call integer evidence-ID probe; never included in ordinary npm test.
...
it('probes evidence message IDs for the authorized session with integer IDs exactly three times',async()=>{
 const directory='test-results/session-memory-evidence-integer-ids';mkdirSync(directory,{recursive:true,mode:0o700});
