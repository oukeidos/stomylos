// Explicit three-call original-product baseline probe; never included in ordinary npm test.
...
it('probes the authorized session with the unmodified product request exactly three times',async()=>{
 const directory='test-results/session-memory-original-baseline';mkdirSync(directory,{recursive:true,mode:0o700});
